...
var (
	...
	errHTTPBadRequestAndroidNotificationIDInvalid   = &errHTTP{40049, http.StatusBadRequest, "invalid request: Android notification ID must be a valid integer", "https://ntfy.sh/docs/publish/#android-notification-id", nil}
