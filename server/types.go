...
type message struct {
	...
	AndroidNotificationID  string      `json:"android_notification_id,omitempty"` // Android notification ID for replacing notifications
...
type publishMessage struct {
	...
	AndroidNotificationID string   `json:"android_notification_id"`
}
