...
| `android_msg_id` | -       | *string*                                          | `disk_space_alert`                                    | Custom Android message ID for [notification replacement](../publish.md#android-notification-replacement) (Android only)           |
